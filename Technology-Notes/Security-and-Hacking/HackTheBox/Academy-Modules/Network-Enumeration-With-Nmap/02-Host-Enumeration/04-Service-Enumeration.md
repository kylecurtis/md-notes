...
```bash
user@htb[/htb]$ sudo nmap 10.129.2.28 -p- -sV
...
```bash
user@htb[/htb]$ sudo nmap 10.129.2.28 -p- -sV --stats-every=5s
...
```bash
user@htb[/htb]$ sudo nmap 10.129.2.28 -p- -sV -v 
...
```bash
user@htb[/htb]$ sudo nmap 10.129.2.28 -p- -sV -Pn -n --disable-arp-ping --packet-trace
...
```bash
user@htb[/htb]$ sudo tcpdump -i eth0 host 10.10.14.2 and 10.129.2.28
...
```bash
user@htb[/htb]$  nc -nv 10.129.2.28 25
