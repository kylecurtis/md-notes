...
```bash
user@htb[/htb]$ sudo nmap <target> -sC
```

#### Specific Scripts Category

```bash
user@htb[/htb]$ sudo nmap <target> --script <category>
```

#### Defined Scripts

```bash
user@htb[/htb]$ sudo nmap <target> --script <script-name>,<script-name>,...
```
...
```bash
user@htb[/htb]$ sudo nmap 10.129.2.28 -p 25 --script banner,smtp-commands
...
```bash
user@htb[/htb]$ sudo nmap 10.129.2.28 -p 80 -A
...
```bash
user@htb[/htb]$ sudo nmap 10.129.2.28 -p 80 -sV --script vuln 
