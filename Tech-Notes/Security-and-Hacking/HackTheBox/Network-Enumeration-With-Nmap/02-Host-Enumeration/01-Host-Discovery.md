...
```bash
user@htb[/htb]$ sudo nmap 10.129.2.0/24 -sn -oA tnet | grep for | cut -d" " -f5
...
```bash
user@htb[/htb]$ sudo nmap -sn -oA tnet -iL hosts.lst | grep for | cut -d" " -f5
...
```bash
user@htb[/htb]$ sudo nmap -sn -oA tnet 10.129.2.18 10.129.2.19 10.129.2.20| grep for | cut -d" " -f5
...
```bash
user@htb[/htb]$ sudo nmap -sn -oA tnet 10.129.2.18-20| grep for | cut -d" " -f5
...
```bash
user@htb[/htb]$ sudo nmap 10.129.2.18 -sn -oA host 
...
```bash
user@htb[/htb]$ sudo nmap 10.129.2.18 -sn -oA host -PE --packet-trace 
...
```bash
user@htb[/htb]$ sudo nmap 10.129.2.18 -sn -oA host -PE --reason 
...
```bash
user@htb[/htb]$ sudo nmap 10.129.2.18 -sn -oA host -PE --packet-trace --disable-arp-ping 
