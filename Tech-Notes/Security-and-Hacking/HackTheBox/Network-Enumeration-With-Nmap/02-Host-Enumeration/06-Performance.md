...
```bash
user@htb[/htb]$ sudo nmap 10.129.2.0/24 -F
...
```bash
user@htb[/htb]$ sudo nmap 10.129.2.0/24 -F --initial-rtt-timeout 50ms --max-rtt-timeout 100ms
...
```bash
user@htb[/htb]$ sudo nmap 10.129.2.0/24 -F | grep "/tcp" | wc -l
...
```bash
user@htb[/htb]$ sudo nmap 10.129.2.0/24 -F --max-retries 0 | grep "/tcp" | wc -l
...
```bash
user@htb[/htb]$ sudo nmap 10.129.2.0/24 -F -oN tnet.default
...
```bash
user@htb[/htb]$ sudo nmap 10.129.2.0/24 -F -oN tnet.minrate300 --min-rate 300
...
```bash
user@htb[/htb]$ cat tnet.default | grep "/tcp" | wc -l
...
```bash
user@htb[/htb]$ cat tnet.minrate300 | grep "/tcp" | wc -l
...
```bash
user@htb[/htb]$ sudo nmap 10.129.2.0/24 -F -oN tnet.T5 -T 5
...
```bash
user@htb[/htb]$ cat tnet.T5 | grep "/tcp" | wc -l
